        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CpfProprietario = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EmailProprietario = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TelefoneProprietario = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NascimentoProprietario = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EnderecoProprietario = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
