        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantidadeHospede = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdEspaco = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NomeEspaco = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Espacos", x => x.IdEspaco);
                    table.ForeignKey(
                        name: "FK_Espacos_Cidades_CidadeIdCidade",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Espacos_CidadeIdCidade",
                table: "Espacos",
